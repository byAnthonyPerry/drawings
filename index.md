...
<body>   
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Lewis Mote</a>
            </div>
    ...
    <div id="about-section" >
        ...
        <h4> I have developed websites for many years now as a hobby. Now i want 
          to go a step futher and try freelancing.</h4>
                </div>
            </div>
            <!-- ./ Main Heading-->
            <div class="row main-low-margin text-center">
                <div class="col-md-3 " data-scrollreveal="enter left and move 100px, wait 0.4s">
                    <img class="img-circle" src="assets/img/lewis.jpg" alt="">
                    <h4><strong>Jhon Deo Alex</strong> </h4>
                    
        <p> . </p>
                    <p>
                       <a href="https://www.facebook.com/lewis.mote.77"><i class="fa fa-facebook-square fa-2x color-facebook"></i></a>
                        <a href="https://twitter.com/home"><i class="fa fa-twitter-square fa-2x color-twitter"></i></a>
    ...
    <div id="products-section" >
         <div class="container" >
            <div class="row main-top-margin text-center" data-scrollreveal="enter top and move 100px, wait 0.7s">
                <div class="col-md-8 col-md-offset-2 ">
